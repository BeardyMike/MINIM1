...
if (ENVIRONMENT == 'development' || ENVIRONMENT == 'dev') {
    ...
    */
    ...
    define('DB_NAME', 'MINIM1');
    define('DB_USER', 'root');
    define('DB_PASS', '12345678');
    define('DB_CHARSET', 'utf8');

    /**
     * OPTIONAL - Configuration for additional Databases
     * Note the use of the DB2_ prefix, each additional server must have a unique prefix
     */
    // define('DB2_TYPE', 'mysql');
    // define('DB2_HOST', '127.0.0.1');
    // define('DB2_NAME', 'OtherDB');
    // define('DB2_USER', 'root');
    // define('DB2_PASS', '123245678');
